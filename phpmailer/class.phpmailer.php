...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = '(a definir durante o envio)';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = '(a definir durante o envio)';
   ...
   * @var string
   */
  public $Host          = 'server1.cibraco.com.br';
   ...
   * @var string
   */
  public $Username      = 'rede@cibraco.com.br';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'cibr@cco20!8';
  ...
  */
  ...
  public function CreateHeader() {
    ...
    if (strlen($this->XCategory) > 0)
      $result .= $this->HeaderLine('X-SMTPAPI', '{"category":"'.$this->XCategory.'"}');
